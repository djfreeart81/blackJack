...
function initializeGame(){
    ...
    cardDeck = new CardDeck(CARD_DECK_SIZE)
    ...
    document.getElementById('button-new-round').addEventListener('click', (event) => {
...
function endRound(){
    ...
    if(winners.length === 0){
        ...
        winners.forEach( (player) => document.getElementById("info").innerHTML = `Congratulation ${player.name}! You won ${BET*2}$`)
    }
}
